#5.Crear un programa con un menú de opciones, que permita calcular las áreas de figuras geométricas: cuadrado, rectángulo, triángulo, círculo, rombo y trapecio.
