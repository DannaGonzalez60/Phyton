#8.Leer el número de llantas de una compra y mostrar el valor que debe pagarse. El almacén las vende con  
# la  siguiente  política:  Si  se  compran  menos  de  5  llantas,  el  precio  unitario  es $240000.  
# Si  se compran 6 o 7, el precio unitario es $221000, y si se compran más de 7 llantas, 
# elprecio unitario es $180000.
